...
@section('title', transWord('إضافة باقة'))
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a
                                            href="#">{{ transWord('إضافة باقة جديدة') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{ transWord('إضافة باقة جديدة') }}</h2>
                                </div>
                                <div class="card-body">
                                    <form class="form form-vertical" action="{{ route('admin.packages.store') }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label
                                                        for="features_ar">{{ transWord('المميزات بالعربي') }}</label>
                                                    <textarea id="features_ar" class="form-control tinyEditor" name="features_ar"
                                                        style="width: 100%; height: 200px;">{{ old('features_ar') }}</textarea>
                                                    @error('features_ar')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label
                                                        for="features_en">{{ transWord('المميزات بالانجليزي') }}</label>
                                                    <textarea id="features_en" class="form-control tinyEditor" name="features_en"
                                                        style="width: 100%; height: 200px;">{{ old('features_en') }}</textarea>
                                                    @error('features_en')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label
                                                        for="flaw_ar">{{ transWord('العيوب بالعربي') }}</label>
                                                    <textarea id="flaw_ar" class="form-control tinyEditor" name="flaw_ar"
                                                        style="width: 100%; height: 200px;">{{ old('flaw_ar') }}</textarea>
                                                    @error('flaw_ar')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label
                                                        for="flaw_en">{{ transWord('العيوب بالانجليزي') }}</label>
                                                    <textarea id="flaw_en" class="form-control tinyEditor" name="flaw_en"
                                                        style="width: 100%; height: 200px;">{{ old('flaw_en') }}</textarea>
                                                    @error('flaw_en')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
                                                    ...
                                                    <select class="form-control select-multiple" id="course_id"
                                                        ...
                                                        @foreach ($courses as $course)
                                                            <option value="{{ $course->id }}"
                                                                {{ collect(old('course_id'))->contains($course->id) ? 'selected' : '' }}>
                                                                {{ $course->title }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('course_id')
