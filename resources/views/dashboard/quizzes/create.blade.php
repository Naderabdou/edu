                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">{{ transWord('إضافة امتحان جديد') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{ transWord('إضافة امتحان جديد') }}</h2>
                                </div>
                                <div class="card-body">
                                    <form class="form form-vertical" id="quizzesFormCreate"
                                        action="{{ route('admin.quizzes.store') }}" method="POST"
