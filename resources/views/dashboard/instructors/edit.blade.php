                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{ transWord('تعديل مدرب') }} - {{ $instructor->first_name }}
                                    </h2>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select-multiple" id="skills"
                                                        ...
                                                        @php
                                                        $skills = collect(old('skills', is_string($instructor->skills) ? explode(',', $instructor->skills) : $instructor->skills));
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="github" class="form-control"
                                                        name="github" value="{{ old('github', $instructor->github) }}" />
                                                    @error('github')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
