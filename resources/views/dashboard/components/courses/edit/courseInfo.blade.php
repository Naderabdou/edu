    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <input type="text" id="title_en" class="form-control"
                    name="title_en"
                    value="{{ old('title_ar', $course->title_en) }}" />
                @error('title_en')
                    <span class="alert alert-danger">
                        <small class="errorTxt">{{ $message }}</small>
                    </span>
        ...
        <div class="col-12">
            <div class="form-group">
                ...
                <input type="text" id="slug_en" class="form-control"
                    name="slug_en"
                    value="{{ old('slug_en', $course->slug_en) }}" />
                @error('slug_en')
                    <span class="alert alert-danger">
                        <small class="errorTxt">{{ $message }}</small>
                    </span>
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <textarea id="about_ar" class="form-control" name="about_ar" style="width: 100%; height: 200px;">{{ old('about_ar', $course->about_ar) }}</textarea>
                @error('about_ar')
                    <span class="alert alert-danger">
                        <small class="errorTxt">{{ $message }}</small>
                    </span>
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <textarea id="about_en" class="form-control" name="about_en" style="width: 100%; height: 200px;">{{ old('about_en', $course->about_en) }}</textarea>
                @error('about_en')
                    <span class="alert alert-danger">
                        <small class="errorTxt">{{ $message }}</small>
                    </span>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select class="form-control select2"
                                ...
                                <option value="expert"
                                    {{ old('level', $course->level) == 'expert' ? 'selected' : '' }}>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select class="form-control select2"
                                ...
                                <option
                                    {{ old('is_public', $course->is_public) === 1 ? 'selected' : '' }}
                                    value="1">{{ transWord('عام') }}
                                </option>
                                <option value="0"
                                    {{ old('is_public', $course->is_public) === 0 ? 'selected' : '' }}>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select class="form-control select2"
                                ...
                                <option
                                    {{ old('is_qa_enabled', $course->is_qa_enabled) === 1 ? 'selected' : '' }}
                                    value="1">{{ transWord('تفعيل') }}
                                </option>
                                <option
                                    {{ old('is_qa_enabled', $course->is_qa_enabled) === 0 ? 'selected' : '' }}
                                    value="0">
        ...
        <div class="col-12">
            <div id="Content_Drip" class="collapse show"
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2"
                                ...
                                <option
                                    {{ old('is_content_drip_enabled', $course->is_content_drip_enabled) == 1 ? 'selected' : '' }}
                                    value="1">{{ transWord('تفعيل') }}
                                </option>
                                <option
                                    {{ old('is_content_drip_enabled', $course->is_content_drip_enabled) == 0 ? 'selected' : '' }}
                                    value="0">
                                    {{ transWord('عدم تفعيل') }}</option>
                            </select>
                    ...
                    <div class="col-6">
                        <div class="form-group"
                            style="display: {{ old('is_content_drip_enabled', $course->is_content_drip_enabled) == 1 ? 'block' : 'none' }}">
                            <label
                            ...
                            <select class="form-control select2"
                                ...
                                <option
                                    {{ old('content_drip_type', $course->content_drip_type) === 'Scheduled' ? 'selected' : '' }}
                                    value="Scheduled">
                                    {{ transWord('Schedule Course Contents By Date') }}
                                </option>
                                <option
                                    {{ old('content_drip_type', $course->Post_Enrollment) === 'Post_Enrollment' ? 'selected' : '' }}
                                    value="Post_Enrollment">
                                    {{ transWord('Content Available After X Days From Enrollment') }}
                                </option>
                                <option
                                    {{ old('content_drip_type', $course->Sequential) === 'Sequential' ? 'selected' : '' }}
                                    value="Sequential">
                                    {{ transWord('Course Content Available Sequentially') }}
                                </option>
                                <option
                                    {{ old('content_drip_type', $course->Prerequisite_Unlocked) === 'Prerequisite_Unlocked' ? 'selected' : '' }}
                ...
                <select class="form-control select-multiple" id="category_id"
                    ...
                    @foreach ($categories as $category)
                        <option value="{{ $category->id }}"
                            {{ old('category_id') == $category->id || $course->categories->pluck('id')->contains($category->id) ? 'selected' : '' }}>
        ...
        <div class="col-12">
            <div class="form-group">
                ...
                <input class=" image filepond" type="file"
                    id="image_course" data-filetype="image" name="image">
