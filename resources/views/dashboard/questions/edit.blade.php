                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">{{ transWord('تعديل سوال ') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <h2 class="card-title" id="questionHeader"> {{ transWord('تعديل السوال') }} - {{ $question->question }} {{ transWord('في الامتحان') }} - {{ $question->quiz->name }}</h2>
                                </div>
                                <div class="card-body">
                                    <form class="form form-vertical" id="questionsFormUpdate"
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="score" class="form-control" name="score"
                                                        value="{{ old('score',$question->score) }}" min="1" />
                                                    @error('score')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="answer_{{ $i }}"
                                                            ...
                                                            value="{{ old('answer.' . $i, $question->answers[$i]->answer) }}" />
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="is_correct"
                                                                id="is_correct" {{ old('is_correct',$question->answers[$i]->is_correct) ? 'checked' : '' }}
                                                                value="{{ $i }}">
